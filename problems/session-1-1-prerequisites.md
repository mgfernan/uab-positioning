# Numerical Problems — Prerequisites
...
1. The **horizontal positioning error**.
...
How long does it take the signal to travel **30 km**?
...
A receiver is known to be exactly \(5\) km away from it.

What geometric object represents all possible receiver positions?

Now suppose a second transmitter is located at

$$
(8,0)\text{ km}
$$

and the receiver is also exactly \(5\) km from this transmitter.
